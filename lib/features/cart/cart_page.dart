...
class _CartPageState extends ConsumerState<CartPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalSp = cartState.items.fold<int>(
      0,
      (total, item) => total + ((item.product.sp ?? 0) * item.quantity),
    );
          ...
          children: [
            ...
            _SavedCartsSection(
              ...
              onLoad: (savedCart) {
                ...
                final missing = notifier.loadSavedCart(savedCart, productsById);
              ...
              onRename: (savedCart) =>
                  _showRenameDialog(context, notifier, savedCart.name),
